 ...
 *
 * @author Saksham Arora, updated Winter 2020
 * @author Egemen Sahin, updated Winter 2020
 */
...
public class Rectangle implements Shape {
	...
	// moves upper left and lower right by dx and dy
	@Override
	...
	// returns true/false if point x, y is within/is outside the rectangle
	@Override
	public boolean contains(int x, int y) {
		return x <= x2 && x >= x1 && y <= y2 && y >= y1;
	}

	// draws the Rectangle by calling g.fillRect
	@Override
	...
	// returns all necessary information about the Rectangle
